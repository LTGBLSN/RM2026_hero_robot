...
void can_sent()
{
    while (1)
    {
        if( rc_receive_state == RC_OFFLINE | yaw_6020_state == GM6020_DIE )//遥控器离线，全车断电
        {
            can_cmd_all(0,
                        0,
                        0,
        ...
        else//遥控器在线，正常进行开关控制
        {
            ...
            else if(rc_s0 == 3 | rc_s0 == 1)//运动模式
            {
                can_cmd_all(0,
                            ...
                            0,
                            0,
                            (int16_t)(rc_ch1*20) );//PITCH_3510_ID5_GIVEN_CURRENT
...
void can_cmd_all(int16_t chassis_id1 , int16_t chassis_id2 ,
                 ...
                 int16_t yaw_id2 , int16_t pitch_id5 ,
                 int16_t friction_wheel_id1,
                 int16_t friction_wheel_id2 ,
                 int16_t friction_wheel_id3 ,
                 int16_t friction_wheel_id4 ,
                 int16_t friction_wheel_id5 ,
                 int16_t friction_wheel_id6 ,
                 int16_t shoot_id7 )
{
    CAN1_cmd_chassis(chassis_id1, chassis_id2, chassis_id3, chassis_id4);
    CAN1_cmd_yaw_pitch_toggle(pitch_id5, yaw_id2, shoot_id7, 0);

    CAN2_cmd_friction_wheels_1234(friction_wheel_id1,
                                  friction_wheel_id2,
                                  friction_wheel_id3,
                                  friction_wheel_id4);

    CAN2_cmd_friction_wheels_5678(friction_wheel_id5,friction_wheel_id6,0,0);
